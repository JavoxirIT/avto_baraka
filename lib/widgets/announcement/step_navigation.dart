...
class StepsNavigation extends StatefulWidget {
  ...
  @override
  State<StepsNavigation> createState() => _StepsNavigationState();
}

class _StepsNavigationState extends State<StepsNavigation> {
  @override
  Widget build(BuildContext context) {
    ...
    final isLastStep =
        widget.currentStep == widget.getSteps(context).length - 1;
    return SafeArea(
      child: Consumer<SendListingProvider>(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () async {
                        Provider.of<KeyboardVisibilityController>(context,
                                listen: false)
                            .hideKeyboard(context);
                        if (widget.currentStep == 0 && regionGroupValue < 0) {
                          toast(
                            context,
                        ...
                        if (widget.currentStep == 2 && carTypeGroupValue < 0) {
                          toast(
                            context,
                        ...
                        if (widget.currentStep == 3 && carBrandGroupValue < 0) {
                          toast(
                            context,
                        ...
                        if (widget.currentStep == 4 && carModelGroupValue < 0) {
                          toast(
                            context,
                        ...
                        if (widget.currentStep == 7 && imageFileList.isEmpty) {
                          toast(
                            context,
                          ...
                          return;
                        } else if (isLastStep && imageFileList.isNotEmpty) {
                          sendListingProvider.setDataSendingStatusIndicator =
                              true;
                          // debugPrint(
                          //     'sendListingProvider.getDataSendingStatusIndicator(): $sendListingProvider..getDataSendingStatusIndicator()');
                          ...
                          if (sendDataResponseStatusText == "Unpaid") {
                            ...
                            unpaidDialog(
                                context, responsDescription, widget.onBackForm);
                            return;
                          }
                          if (sendDataResponseStatusText == "success") {
                            ...
                            successDialog(context, widget.onBackForm);
                            return;
                          }
